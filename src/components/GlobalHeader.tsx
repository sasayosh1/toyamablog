      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <button
            ...
            className="flex items-center justify-center w-8 h-8 text-gray-700 hover:text-gray-900 focus:outline-none"
          >
          ...
          <div ref={searchRef} className="relative flex-1 max-w-md mx-4">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
              />
          ...
          <nav className="max-w-7xl mx-auto px-4 py-4">
            <div className="flex flex-col space-y-3">
              ...
              >
                ...
                <span className="text-xl font-bold">TOYAMA BLOG</span>
              </Link>
              <Link
                href="/"
                className="flex items-center px-3 py-2 text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-md transition-colors"
