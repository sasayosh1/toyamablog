...
export default function CategoryHero({ title, subtitle, description }: CategoryHeroProps) {
    return (
        <div 
            className="relative overflow-hidden rounded-3xl mb-12 text-white shadow-lg border border-white/10"
            style={{ 
                background: 'linear-gradient(to bottom right, #0284c7, #0ea5e9)',
                backgroundColor: '#0284c7' 
            }}
        >
            <div className="absolute top-0 right-0 -mt-10 -mr-10 w-64 h-64 bg-white opacity-20 rounded-full blur-3xl"></div>
            <div className="absolute bottom-0 left-0 -mb-10 -ml-10 w-40 h-40 bg-emerald-500 opacity-30 rounded-full blur-2xl"></div>
