...
export const metadata = {
  title: 'Categories by Region | Do you like Toyama?',
  description: 'You can search for articles from each region in Toyama Prefecture. This is a regional category page organized by municipality.',
}
        ...
        {categoriesWithCounts.length === 0 ? (
          <div className="text-center py-12">
            <div className="bg-white rounded-lg shadow-sm p-8">
              {categoryIcon}
              <p className="text-gray-600 text-lg">No regional categories found</p>
            </div>
          </div>
        ) : (
          <>
            ...
            <div className="mb-8 text-center">
              <p className="text-gray-800 text-lg">
                Total <span className="font-bold text-green-600">{categoriesWithCounts.length}</span> Regions / <span className="font-bold text-blue-600">{posts.length}</span> Articles
              </p>
            </div>
