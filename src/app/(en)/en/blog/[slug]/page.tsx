...
export const dynamicParams = true // 生成されていないパスへのアクセス時はオンデマンド生成
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    title: cleanTitle,
    description: post.excerptEn || post.excerpt || post.description || `Detailed information about ${cleanTitle}`,
    keywords: post.tags || [post.titleEn || post.title],
    authors: [{ name: 'Sasayoshi', url: 'https://sasakiyoshimasa.com/en' }],
    openGraph: {
      title: cleanTitle,
      description: post.excerptEn || post.excerpt || post.description || `Detailed information about ${cleanTitle}`,
      url: `https://sasakiyoshimasa.com/en/blog/${slug}`,
      ...
      publishedTime,
      modifiedTime,
      section: post.category || 'Toyama',
      tags: post.tags || [post.category || 'Toyama'],
    },
    twitter: {
    ...
    alternates: {
      canonical: `https://sasakiyoshimasa.com/en/blog/${slug}`,
    },
  }
}
...
export default async function PostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const breadcrumbLD = generateBreadcrumbLD([
    ...
    ...(post.category ? [{ name: post.category, url: `https://sasakiyoshimasa.com/en/category/${encodeURIComponent(post.category)}` }] : []),
    { name: cleanTitle }
  ])
