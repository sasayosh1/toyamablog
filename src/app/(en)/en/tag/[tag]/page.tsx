              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    There might be spelling variations for this tag. Please check other options via the search bar or categories list.
                  </p>
...
export async function generateMetadata({ params }: { params: Promise<{ tag: string }> }): Promise<Metadata> {
  ...
  const canonical = `https://sasakiyoshimasa.com/en/tag/${encodeURIComponent(decodedTag)}`
  ...
  return {
    title: `${decodedTag} - Tag | Do you like Toyama?`,
    description: `List of articles tagged with "${decodedTag}" showing the charms of Toyama.`,
