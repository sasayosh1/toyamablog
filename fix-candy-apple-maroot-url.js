...
async function fixCandyAppleMarootYouTubeUrl() {
  try {
    console.log('🔧 candy-apple-maroot記事のYouTube URLを修正します\n');
    
    const targetSlug = 'toyama-city-candy-apple-maroot';
    const correctYouTubeUrl = 'https://youtube.com/shorts/7Up4Aa6Fpzo';
