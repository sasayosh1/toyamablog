...
async function findMediumBatch7Articles() {
  ...
  console.log('=== 中記事第7バッチ候補（第31-35記事）- スマホ最適化版 ===');
  ...
  console.log(`処理済み: 30記事`);
  console.log(`第7バッチ対象: ${seventhBatch.length}記事`);
  console.log(`残り: ${candidates.length - 35}記事`);
}

findMediumBatch7Articles().catch(console.error);