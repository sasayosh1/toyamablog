...
async function fixCakeStationYouTubeUrl() {
  try {
    console.log('🔧 cake-station記事のYouTube URLを修正します\n');
    
    const targetSlug = 'toyama-city-cake-station';
    const correctYouTubeUrl = 'https://youtube.com/shorts/AsITELrVTL0';
