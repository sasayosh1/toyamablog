...
async function fixToyamaCity50YouTubeUrl() {
  try {
    console.log('🔧 toyama-city-50記事のYouTube URLを修正します\n');
    
    const targetSlug = 'toyama-city-50';
    const correctYouTubeUrl = 'https://youtube.com/shorts/zGQDYmJTfL4';
