...
async function addYouTubeToKamiichiTemple() {
  try {
    console.log('📹 上市町のお寺記事にYouTube動画を追加中...');
    ...
    if (!post) {
      console.log('❌ kamiichi-town-temple-2 記事が見つかりませんでした');
    ...
    console.log('\\n🎯 変更内容:');
    console.log('📱 記事ページにYouTube動画が表示されます');
    console.log('🖼️ 記事カードにYouTubeサムネイルが表示されます');
    console.log('🏷️ YouTube バッジが記事カードに追加されます');
    console.log('🔗 動画内容と記事内容が連携します');
