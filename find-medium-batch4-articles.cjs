...
async function findMediumBatch4Articles() {
  ...
  console.log('=== 中記事第4バッチ候補（第16-20記事）===');
  ...
  console.log(`処理済み: 15記事`);
  console.log(`第4バッチ対象: 5記事`);
  console.log(`残り: ${candidates.length - 20}記事`);
}

findMediumBatch4Articles().catch(console.error);